...
function GeneratePortraitModal({ classes, characterId, handleClose }) {
  ...
  return (
    <Dialog open={true} onClose={handleClose}>
      <DialogTitle>Integração para o OBS</DialogTitle>
      <DialogContent>
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <span>Link para o portrait (escolha o que deve ser mostrado):</span>
            <FormGroup>
              <FormControlLabel
                control={
                  <Checkbox
        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <span>Link para os dados em tela:</span>
          </Grid>
          <Grid item xs={12}>
            <TextFieldIcon
              variant="outlined"
